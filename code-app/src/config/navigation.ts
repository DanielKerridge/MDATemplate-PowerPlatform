    ...
    groups: [
      {
        ...
        label: "Management",
        items: [
          { key: "projects", label: "Projects", icon: BoardRegular, path: "/projects" },
          { key: "tasks", label: "Tasks", icon: TaskListSquareLtrRegular, path: "/tasks" },
        ],
      },
      {
        key: "tracking",
        label: "Tracking",
        items: [
          { key: "timeentries", label: "Time Entries", icon: ClockRegular, path: "/timeentries" },
        ],
      },
    ],
  },
